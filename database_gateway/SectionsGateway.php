...
class SectionsGateway {
    ...
    public function select_section($section_id) {
        ...
        $sections_rec = mysql_query("SELECT * FROM " . $this->sections_table . " where section_id=$dbsection_id;");
    ...
    public function select_all_sections() {
        ...
        $sections_rec = mysql_query("SELECT * FROM " . $this->sections_table . " ORDER BY Section_Id ASC;");
